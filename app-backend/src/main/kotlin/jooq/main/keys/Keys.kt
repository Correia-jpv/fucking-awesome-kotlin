...
val ARTICLE__ARTICLE_CREATED_BY_FKEY: ForeignKey<ArticleRecord, KotlinerRecord> = Internal.createForeignKey(Article.ARTICLE, DSL.name("article_created_by_fkey"), arrayOf(Article.ARTICLE.CREATED_BY), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val ARTICLE__ARTICLE_ORIGINAL_ID_FKEY: ForeignKey<ArticleRecord, ArticleRecord> = Internal.createForeignKey(Article.ARTICLE, DSL.name("article_original_id_fkey"), arrayOf(Article.ARTICLE.ORIGINAL_ID), jooq.main.keys.ARTICLE_PKEY, arrayOf(Article.ARTICLE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val ARTICLE__ARTICLE_UPDATED_BY_FKEY: ForeignKey<ArticleRecord, KotlinerRecord> = Internal.createForeignKey(Article.ARTICLE, DSL.name("article_updated_by_fkey"), arrayOf(Article.ARTICLE.UPDATED_BY), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val ARTICLE_AUTHOR__ARTICLE_AUTHOR_ARTICLE_ID_FKEY: ForeignKey<ArticleAuthorRecord, ArticleRecord> = Internal.createForeignKey(ArticleAuthor.ARTICLE_AUTHOR, DSL.name("article_author_article_id_fkey"), arrayOf(ArticleAuthor.ARTICLE_AUTHOR.ARTICLE_ID), jooq.main.keys.ARTICLE_PKEY, arrayOf(Article.ARTICLE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val ARTICLE_AUTHOR__ARTICLE_AUTHOR_KOTLINER_ID_FKEY: ForeignKey<ArticleAuthorRecord, KotlinerRecord> = Internal.createForeignKey(ArticleAuthor.ARTICLE_AUTHOR, DSL.name("article_author_kotliner_id_fkey"), arrayOf(ArticleAuthor.ARTICLE_AUTHOR.KOTLINER_ID), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val ARTICLE_KOTLIN_VERSION__ARTICLE_KOTLIN_VERSION_ARTICLE_ID_FKEY: ForeignKey<ArticleKotlinVersionRecord, ArticleRecord> = Internal.createForeignKey(ArticleKotlinVersion.ARTICLE_KOTLIN_VERSION, DSL.name("article_kotlin_version_article_id_fkey"), arrayOf(ArticleKotlinVersion.ARTICLE_KOTLIN_VERSION.ARTICLE_ID), jooq.main.keys.ARTICLE_PKEY, arrayOf(Article.ARTICLE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
...
val ARTICLE_LIBRARY__ARTICLE_LIBRARY_ARTICLE_ID_FKEY: ForeignKey<ArticleLibraryRecord, ArticleRecord> = Internal.createForeignKey(ArticleLibrary.ARTICLE_LIBRARY, DSL.name("article_library_article_id_fkey"), arrayOf(ArticleLibrary.ARTICLE_LIBRARY.ARTICLE_ID), jooq.main.keys.ARTICLE_PKEY, arrayOf(Article.ARTICLE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val ARTICLE_LIBRARY__ARTICLE_LIBRARY_LIBRARY_ID_FKEY: ForeignKey<ArticleLibraryRecord, LibraryRecord> = Internal.createForeignKey(ArticleLibrary.ARTICLE_LIBRARY, DSL.name("article_library_library_id_fkey"), arrayOf(ArticleLibrary.ARTICLE_LIBRARY.LIBRARY_ID), jooq.main.keys.LIBRARY_PKEY, arrayOf(Library.LIBRARY.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val ARTICLE_TOPIC__ARTICLE_TOPIC_ARTICLE_ID_FKEY: ForeignKey<ArticleTopicRecord, ArticleRecord> = Internal.createForeignKey(ArticleTopic.ARTICLE_TOPIC, DSL.name("article_topic_article_id_fkey"), arrayOf(ArticleTopic.ARTICLE_TOPIC.ARTICLE_ID), jooq.main.keys.ARTICLE_PKEY, arrayOf(Article.ARTICLE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val ARTICLE_TOPIC__ARTICLE_TOPIC_TOPIC_ID_FKEY: ForeignKey<ArticleTopicRecord, TopicRecord> = Internal.createForeignKey(ArticleTopic.ARTICLE_TOPIC, DSL.name("article_topic_topic_id_fkey"), arrayOf(ArticleTopic.ARTICLE_TOPIC.TOPIC_ID), jooq.main.keys.TOPIC_PKEY, arrayOf(Topic.TOPIC.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val BOOK_LIBRARY__BOOK_LIBRARY_BOOK_ID_FKEY: ForeignKey<BookLibraryRecord, BookRecord> = Internal.createForeignKey(BookLibrary.BOOK_LIBRARY, DSL.name("book_library_book_id_fkey"), arrayOf(BookLibrary.BOOK_LIBRARY.BOOK_ID), jooq.main.keys.BOOK_PKEY, arrayOf(Book.BOOK.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val BOOK_LIBRARY__BOOK_LIBRARY_LIBRARY_ID_FKEY: ForeignKey<BookLibraryRecord, LibraryRecord> = Internal.createForeignKey(BookLibrary.BOOK_LIBRARY, DSL.name("book_library_library_id_fkey"), arrayOf(BookLibrary.BOOK_LIBRARY.LIBRARY_ID), jooq.main.keys.LIBRARY_PKEY, arrayOf(Library.LIBRARY.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val BOOK_SPEAKER__BOOK_SPEAKER_BOOK_ID_FKEY: ForeignKey<BookSpeakerRecord, BookRecord> = Internal.createForeignKey(BookSpeaker.BOOK_SPEAKER, DSL.name("book_speaker_book_id_fkey"), arrayOf(BookSpeaker.BOOK_SPEAKER.BOOK_ID), jooq.main.keys.BOOK_PKEY, arrayOf(Book.BOOK.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val BOOK_SPEAKER__BOOK_SPEAKER_KOTLINER_ID_FKEY: ForeignKey<BookSpeakerRecord, KotlinerRecord> = Internal.createForeignKey(BookSpeaker.BOOK_SPEAKER, DSL.name("book_speaker_kotliner_id_fkey"), arrayOf(BookSpeaker.BOOK_SPEAKER.KOTLINER_ID), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val COMMENT__COMMENT_KOTLINER_ID_FKEY: ForeignKey<CommentRecord, KotlinerRecord> = Internal.createForeignKey(Comment.COMMENT, DSL.name("comment_kotliner_id_fkey"), arrayOf(Comment.COMMENT.KOTLINER_ID), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val COMMENT__COMMENT_PARENT_ID_FKEY: ForeignKey<CommentRecord, CommentRecord> = Internal.createForeignKey(Comment.COMMENT, DSL.name("comment_parent_id_fkey"), arrayOf(Comment.COMMENT.PARENT_ID), jooq.main.keys.COMMENT_PKEY, arrayOf(Comment.COMMENT.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val COURSE_LIBRARY__COURSE_LIBRARY_COURSE_ID_FKEY: ForeignKey<CourseLibraryRecord, CourseRecord> = Internal.createForeignKey(CourseLibrary.COURSE_LIBRARY, DSL.name("course_library_course_id_fkey"), arrayOf(CourseLibrary.COURSE_LIBRARY.COURSE_ID), jooq.main.keys.COURSE_PKEY, arrayOf(Course.COURSE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val COURSE_LIBRARY__COURSE_LIBRARY_LIBRARY_ID_FKEY: ForeignKey<CourseLibraryRecord, LibraryRecord> = Internal.createForeignKey(CourseLibrary.COURSE_LIBRARY, DSL.name("course_library_library_id_fkey"), arrayOf(CourseLibrary.COURSE_LIBRARY.LIBRARY_ID), jooq.main.keys.LIBRARY_PKEY, arrayOf(Library.LIBRARY.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val COURSE_SPEAKER__COURSE_SPEAKER_COURSE_ID_FKEY: ForeignKey<CourseSpeakerRecord, CourseRecord> = Internal.createForeignKey(CourseSpeaker.COURSE_SPEAKER, DSL.name("course_speaker_course_id_fkey"), arrayOf(CourseSpeaker.COURSE_SPEAKER.COURSE_ID), jooq.main.keys.COURSE_PKEY, arrayOf(Course.COURSE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val COURSE_SPEAKER__COURSE_SPEAKER_KOTLINER_ID_FKEY: ForeignKey<CourseSpeakerRecord, KotlinerRecord> = Internal.createForeignKey(CourseSpeaker.COURSE_SPEAKER, DSL.name("course_speaker_kotliner_id_fkey"), arrayOf(CourseSpeaker.COURSE_SPEAKER.KOTLINER_ID), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val KOTLINER_LIKE_ENTITY_STATE__KOTLINER_LIKE_ENTITY_STATE_KOTLINER_ID_FKEY: ForeignKey<KotlinerLikeEntityStateRecord, KotlinerRecord> = Internal.createForeignKey(KotlinerLikeEntityState.KOTLINER_LIKE_ENTITY_STATE, DSL.name("kotliner_like_entity_state_kotliner_id_fkey"), arrayOf(KotlinerLikeEntityState.KOTLINER_LIKE_ENTITY_STATE.KOTLINER_ID), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val KOTLINER_READ_ENTITY_STATE__KOTLINER_READ_ENTITY_STATE_KOTLINER_ID_FKEY: ForeignKey<KotlinerReadEntityStateRecord, KotlinerRecord> = Internal.createForeignKey(KotlinerReadEntityState.KOTLINER_READ_ENTITY_STATE, DSL.name("kotliner_read_entity_state_kotliner_id_fkey"), arrayOf(KotlinerReadEntityState.KOTLINER_READ_ENTITY_STATE.KOTLINER_ID), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
...
val KUG_EVENT__KUG_EVENT_KUG_ID_FKEY: ForeignKey<KugEventRecord, KugRecord> = Internal.createForeignKey(KugEvent.KUG_EVENT, DSL.name("kug_event_kug_id_fkey"), arrayOf(KugEvent.KUG_EVENT.KUG_ID), jooq.main.keys.KUG_PKEY, arrayOf(Kug.KUG.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val KUG_EVENT__KUG_EVENT_UPDATED_BY_FKEY: ForeignKey<KugEventRecord, KotlinerRecord> = Internal.createForeignKey(KugEvent.KUG_EVENT, DSL.name("kug_event_updated_by_fkey"), arrayOf(KugEvent.KUG_EVENT.UPDATED_BY), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val KUG_MEMBER__KUG_MEMBER_KOTLINER_ID_FKEY: ForeignKey<KugMemberRecord, KotlinerRecord> = Internal.createForeignKey(KugMember.KUG_MEMBER, DSL.name("kug_member_kotliner_id_fkey"), arrayOf(KugMember.KUG_MEMBER.KOTLINER_ID), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val KUG_MEMBER__KUG_MEMBER_KUG_ID_FKEY: ForeignKey<KugMemberRecord, KugRecord> = Internal.createForeignKey(KugMember.KUG_MEMBER, DSL.name("kug_member_kug_id_fkey"), arrayOf(KugMember.KUG_MEMBER.KUG_ID), jooq.main.keys.KUG_PKEY, arrayOf(Kug.KUG.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
...
val TOPIC__TOPIC_PARENT_ID_FKEY: ForeignKey<TopicRecord, TopicRecord> = Internal.createForeignKey(Topic.TOPIC, DSL.name("topic_parent_id_fkey"), arrayOf(Topic.TOPIC.PARENT_ID), jooq.main.keys.TOPIC_PKEY, arrayOf(Topic.TOPIC.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val VACANCY__VACANCY_COMPANY_ID_FKEY: ForeignKey<VacancyRecord, CompanyRecord> = Internal.createForeignKey(Vacancy.VACANCY, DSL.name("vacancy_company_id_fkey"), arrayOf(Vacancy.VACANCY.COMPANY_ID), jooq.main.keys.COMPANY_PKEY, arrayOf(Company.COMPANY.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val VACANCY__VACANCY_KOTLINER_ID_FKEY: ForeignKey<VacancyRecord, KotlinerRecord> = Internal.createForeignKey(Vacancy.VACANCY, DSL.name("vacancy_kotliner_id_fkey"), arrayOf(Vacancy.VACANCY.KOTLINER_ID), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val VIDEO_LIBRARY__VIDEO_LIBRARY_LIBRARY_ID_FKEY: ForeignKey<VideoLibraryRecord, LibraryRecord> = Internal.createForeignKey(VideoLibrary.VIDEO_LIBRARY, DSL.name("video_library_library_id_fkey"), arrayOf(VideoLibrary.VIDEO_LIBRARY.LIBRARY_ID), jooq.main.keys.LIBRARY_PKEY, arrayOf(Library.LIBRARY.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val VIDEO_LIBRARY__VIDEO_LIBRARY_VIDEO_ID_FKEY: ForeignKey<VideoLibraryRecord, VideoRecord> = Internal.createForeignKey(VideoLibrary.VIDEO_LIBRARY, DSL.name("video_library_video_id_fkey"), arrayOf(VideoLibrary.VIDEO_LIBRARY.VIDEO_ID), jooq.main.keys.VIDEO_PKEY, arrayOf(Video.VIDEO.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val VIDEO_SPEAKER__VIDEO_SPEAKER_KOTLINER_ID_FKEY: ForeignKey<VideoSpeakerRecord, KotlinerRecord> = Internal.createForeignKey(VideoSpeaker.VIDEO_SPEAKER, DSL.name("video_speaker_kotliner_id_fkey"), arrayOf(VideoSpeaker.VIDEO_SPEAKER.KOTLINER_ID), jooq.main.keys.KOTLINER_PKEY, arrayOf(Kotliner.KOTLINER.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val VIDEO_SPEAKER__VIDEO_SPEAKER_VIDEO_ID_FKEY: ForeignKey<VideoSpeakerRecord, VideoRecord> = Internal.createForeignKey(VideoSpeaker.VIDEO_SPEAKER, DSL.name("video_speaker_video_id_fkey"), arrayOf(VideoSpeaker.VIDEO_SPEAKER.VIDEO_ID), jooq.main.keys.VIDEO_PKEY, arrayOf(Video.VIDEO.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
