...
open class VideoLibrary(
    ...
    val library: LibraryPath by lazy { LibraryPath(this, VIDEO_LIBRARY__VIDEO_LIBRARY_LIBRARY_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.video</code> table.
     */
    fun video(): VideoPath = video
    val video: VideoPath by lazy { VideoPath(this, VIDEO_LIBRARY__VIDEO_LIBRARY_VIDEO_ID_FKEY, null) }
