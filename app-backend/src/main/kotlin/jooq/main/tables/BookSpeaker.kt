...
open class BookSpeaker(
    ...
    val book: BookPath by lazy { BookPath(this, BOOK_SPEAKER__BOOK_SPEAKER_BOOK_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.kotliner</code> table.
     */
    fun kotliner(): KotlinerPath = kotliner
    val kotliner: KotlinerPath by lazy { KotlinerPath(this, BOOK_SPEAKER__BOOK_SPEAKER_KOTLINER_ID_FKEY, null) }
