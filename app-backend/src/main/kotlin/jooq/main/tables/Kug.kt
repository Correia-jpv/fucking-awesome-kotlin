...
import jooq.main.keys.KUG_PKEY
...
open class Kug(
     ...
     */
    fun kugCreatedByFkey(): KotlinerPath = kugCreatedByFkey
    val kugCreatedByFkey: KotlinerPath by lazy { KotlinerPath(this, KUG__KUG_CREATED_BY_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.kotliner</code> table, via
     * the <code>kug_updated_by_fkey</code> key.
     */
    fun kugUpdatedByFkey(): KotlinerPath = kugUpdatedByFkey
    val kugUpdatedByFkey: KotlinerPath by lazy { KotlinerPath(this, KUG__KUG_UPDATED_BY_FKEY, null) }
