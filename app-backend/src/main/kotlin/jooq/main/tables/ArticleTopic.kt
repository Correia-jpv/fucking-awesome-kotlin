...
open class ArticleTopic(
    ...
    val article: ArticlePath by lazy { ArticlePath(this, ARTICLE_TOPIC__ARTICLE_TOPIC_ARTICLE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.topic</code> table.
     */
    fun topic(): TopicPath = topic
    val topic: TopicPath by lazy { TopicPath(this, ARTICLE_TOPIC__ARTICLE_TOPIC_TOPIC_ID_FKEY, null) }
