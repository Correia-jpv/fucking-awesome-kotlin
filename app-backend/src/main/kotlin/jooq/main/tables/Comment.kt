...
open class Comment(
    ...
    val kotliner: KotlinerPath by lazy { KotlinerPath(this, COMMENT__COMMENT_KOTLINER_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.comment</code> table.
     */
    fun comment(): CommentPath = comment
    val comment: CommentPath by lazy { CommentPath(this, COMMENT__COMMENT_PARENT_ID_FKEY, null) }
