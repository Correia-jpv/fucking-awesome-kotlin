 ...
 */
@Suppress("warnings")
data class KotlinerReadEntityState(
    var kotlinerId: Long? = null,
    var entityId: Long? = null,
    var readState: ReadStateEnum? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: KotlinerReadEntityState = other as KotlinerReadEntityState
        ...
        else if (this.readState != o.readState)
            return false
    ...
    override fun hashCode(): Int {
        ...
        result = prime * result + (if (this.readState == null) 0 else this.readState.hashCode())
    ...
    override fun toString(): String {
        val sb = StringBuilder("KotlinerReadEntityState (")
