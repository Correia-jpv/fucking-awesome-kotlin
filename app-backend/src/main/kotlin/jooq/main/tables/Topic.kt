...
import jooq.main.keys.TOPIC_PKEY
import jooq.main.keys.TOPIC__TOPIC_PARENT_ID_FKEY
...
open class Topic(
    ...
    val topic: TopicPath by lazy { TopicPath(this, TOPIC__TOPIC_PARENT_ID_FKEY, null) }
