...
open class ArticleLibrary(
    ...
    val article: ArticlePath by lazy { ArticlePath(this, ARTICLE_LIBRARY__ARTICLE_LIBRARY_ARTICLE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.library</code> table.
     */
    fun library(): LibraryPath = library
    val library: LibraryPath by lazy { LibraryPath(this, ARTICLE_LIBRARY__ARTICLE_LIBRARY_LIBRARY_ID_FKEY, null) }
