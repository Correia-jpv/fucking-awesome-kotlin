...
open class KugMember(
    ...
    val kotliner: KotlinerPath by lazy { KotlinerPath(this, KUG_MEMBER__KUG_MEMBER_KOTLINER_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.kug</code> table.
     */
    fun kug(): KugPath = kug
    val kug: KugPath by lazy { KugPath(this, KUG_MEMBER__KUG_MEMBER_KUG_ID_FKEY, null) }
