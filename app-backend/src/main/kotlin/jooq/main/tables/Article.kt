...
open class Article(
     ...
     */
    fun articleCreatedByFkey(): KotlinerPath = articleCreatedByFkey
    val articleCreatedByFkey: KotlinerPath by lazy { KotlinerPath(this, ARTICLE__ARTICLE_CREATED_BY_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.article</code> table.
     */
    fun article(): ArticlePath = article
    val article: ArticlePath by lazy { ArticlePath(this, ARTICLE__ARTICLE_ORIGINAL_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>public.kotliner</code> table, via
     * the <code>article_updated_by_fkey</code> key.
     */
    fun articleUpdatedByFkey(): KotlinerPath = articleUpdatedByFkey
    val articleUpdatedByFkey: KotlinerPath by lazy { KotlinerPath(this, ARTICLE__ARTICLE_UPDATED_BY_FKEY, null) }
